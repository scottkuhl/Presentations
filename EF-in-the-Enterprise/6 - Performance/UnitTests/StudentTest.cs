...
namespace ContosoUniversity.UnitTests
{
    ...
    public class StudentTest
    {
        ...
        public void CreateStudent()
        {
            ...
            var student = new Student() { LastName = expectedLastName, FirstMidName = "Test", Email="test@constosou.edu", EnrollmentDate = new DateTime(2013,8,1) };
        ...
        public void EditStudent()
        {
            ...
            var studentId = 1;
            var expectedLastName = "Unit Test";
            var student = new Student() { PersonID = studentId, LastName = expectedLastName, FirstMidName = "Test", Email="test@contosou.edu", EnrollmentDate = new DateTime(2013,8,1) };
