...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets71568E24148BCA1730B444675374AD0ADC12DF816520C9A27E148D2E31802D55))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets71568E24148BCA1730B444675374AD0ADC12DF816520C9A27E148D2E31802D55 : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets71568E24148BCA1730B444675374AD0ADC12DF816520C9A27E148D2E31802D55()
        {
            this.EdmEntityContainerName = "SchoolContext";
            this.StoreEntityContainerName = "CodeFirstDatabase";
            this.HashOverMappingClosure = "8312c8f0a96c9873ad62d103d77749eb4b5e74a10d4833cb13ffcbd51f89790e";
            this.HashOverAllExtentViews = "1d160471e6fa05ce79a81e0e82e31ef27045d2527e1e5e3a3a1c7217c2fcd7cb";
            this.ViewCount = 16;
        }
    ...
    FROM (
        ...
        /// <Summary>
        /// return view for CodeFirstDatabase.PerformanceLog
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView14()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("CodeFirstDatabase.PerformanceLog", @"
    SELECT VALUE -- Constructing PerformanceLog
        [CodeFirstDatabaseSchema.PerformanceLog](T1.PerformanceLog_PerformanceLogId, T1.PerformanceLog_Action, T1.PerformanceLog_Model, T1.PerformanceLog_Query, T1.PerformanceLog_Date, T1.PerformanceLog_Execution, T1.PerformanceLog_User, T1.PerformanceLog_IPAddress, T1.PerformanceLog_RequestUrl)
    FROM (
        SELECT 
            T.PerformanceLogId AS PerformanceLog_PerformanceLogId, 
            T.Action AS PerformanceLog_Action, 
            T.Model AS PerformanceLog_Model, 
            T.Query AS PerformanceLog_Query, 
            T.Date AS PerformanceLog_Date, 
            T.Execution AS PerformanceLog_Execution, 
            T.User AS PerformanceLog_User, 
            T.IPAddress AS PerformanceLog_IPAddress, 
            T.RequestUrl AS PerformanceLog_RequestUrl, 
            True AS _from0
        FROM SchoolContext.PerformanceLog AS T
    ) AS T1");
        }
        
        /// <Summary>
        /// return view for SchoolContext.PerformanceLog
        /// </Summary>
        private System.Collections.Generic.KeyValuePair<string, string> GetView15()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("SchoolContext.PerformanceLog", @"
    SELECT VALUE -- Constructing PerformanceLog
        [ContosoUniversity.DAL.PerformanceLog](T1.PerformanceLog_PerformanceLogId, T1.PerformanceLog_Action, T1.PerformanceLog_Model, T1.PerformanceLog_Query, T1.PerformanceLog_Date, T1.PerformanceLog_Execution, T1.PerformanceLog_User, T1.PerformanceLog_IPAddress, T1.PerformanceLog_RequestUrl)
    FROM (
        SELECT 
            T.PerformanceLogId AS PerformanceLog_PerformanceLogId, 
            T.Action AS PerformanceLog_Action, 
