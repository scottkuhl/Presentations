...
namespace ContosoUniversity.UnitTests
{
    ...
    public class AuditTest
    {
        ...
        public void CreateStudent()
        {
            ...
            var student = new Student() { LastName = "Unit", FirstMidName = "Test", EnrollmentDate = new DateTime(2013,8,1) };
        ...
        public void EditStudent()
        {
            ...
            var student = new Student() { PersonID = expectedTableId, LastName = "Unit Test", FirstMidName = "Test", EnrollmentDate = new DateTime(2013, 8, 1) };
