...
GO
ALTER TABLE [dbo].[OfficeAssignment] WITH NOCHECK
...
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator) VALUES ('Olivetto', 'Nino', '9/1/2015', 'Student'); DECLARE @Person_Olivetto INT = @@IDENTITY;
...
GO
ALTER TABLE [dbo].[Course] WITH CHECK CHECK CONSTRAINT [FK_dbo.Course_dbo.Department_DepartmentID];

ALTER TABLE [dbo].[CourseInstructor] WITH CHECK CHECK CONSTRAINT [FK_dbo.CourseInstructor_dbo.Course_CourseID];

ALTER TABLE [dbo].[CourseInstructor] WITH CHECK CHECK CONSTRAINT [FK_dbo.CourseInstructor_dbo.Person_PersonID];

ALTER TABLE [dbo].[Department] WITH CHECK CHECK CONSTRAINT [FK_dbo.Department_dbo.Person_PersonID];

ALTER TABLE [dbo].[Enrollment] WITH CHECK CHECK CONSTRAINT [FK_dbo.Enrollment_dbo.Course_CourseID];

ALTER TABLE [dbo].[Enrollment] WITH CHECK CHECK CONSTRAINT [FK_dbo.Enrollment_dbo.Person_PersonID];

ALTER TABLE [dbo].[OfficeAssignment] WITH CHECK CHECK CONSTRAINT [FK_dbo.OfficeAssignment_dbo.Person_PersonID];
