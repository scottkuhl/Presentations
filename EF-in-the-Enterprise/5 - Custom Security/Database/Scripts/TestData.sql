-- Students
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Alexander', 'Carson', '9/1/2010', 'Student', 'alexander@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Alexander INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Alonso', 'Meredith', '9/1/2012', 'Student', 'alonso@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Alonso INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Anand', 'Arturo', '9/1/2013', 'Student', 'anand@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Anand INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Barzdukas', 'Gytis', '9/1/2012', 'Student', 'barzdukas@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Barzdukas INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Li', 'Yan', '9/1/2012', 'Student', 'UnitTest', 'li@contoso.edu', GETDATE()); DECLARE @Person_Li INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Justice', 'Peggy', '9/1/2011', 'Student', 'justice@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Justice INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Norman', 'Laura', '9/1/2013', 'Student', 'norman@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Norman INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, EnrollmentDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Olivetto', 'Nino', '9/1/2005', 'Student', 'olivetto@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Olivetto INT = @@IDENTITY;

-- Instructors
INSERT INTO dbo.Person (LastName, FirstName, HireDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Abercrombie', 'Kim', '3/11/1995', 'Instructor', 'abercrombie@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Abercrombie INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, HireDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Fakhouri', 'Fadi', '7/6/2002', 'Instructor', 'fakhouri@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Fakhouri INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, HireDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Harui', 'Roger', '7/1/1998', 'Instructor', 'harui@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Harui INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, HireDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Kapoor', 'Candace', '1/15/2001', 'Instructor', 'kapoor@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Kapoor INT = @@IDENTITY;
INSERT INTO dbo.Person (LastName, FirstName, HireDate, Discriminator, Email, CreatedBy, CreatedOn) VALUES ('Zheng', 'Roger', '2/12/2004', 'Instructor', 'zheng@contoso.edu', 'UnitTest', GETDATE()); DECLARE @Person_Zheng INT = @@IDENTITY;
